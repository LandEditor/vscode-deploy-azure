...
export enum TemplateAssetType {
	...
	AzureARMPublishProfileServiceConnection = "endpoint:" +
		ServiceConnectionType.AzureRM +
		":publishProfile",
	ACRServiceConnection = "endpoint:" + ServiceConnectionType.ACR,
	AKSKubeConfigServiceConnection = "endpoint:" +
		ServiceConnectionType.AKS +
		":kubeconfig",

	GitHubARM = "gitHubSecret:" + GitHubSecretType.AzureRM,
	GitHubARMPublishProfile = "gitHubSecret:" +
		GitHubSecretType.AzureRM +
		":publishProfile",
	GitHubAKSKubeConfig = "gitHubSecret:" +
		GitHubSecretType.AKSKubeConfigSecret +
		":kubeconfig",
	GitHubRegistryUsername = "gitHubSecret:" +
		GitHubSecretType.ContainerRegistryUsername,
	GitHubRegistryPassword = "gitHubSecret:" +
		GitHubSecretType.ContainerRegistryPassword,
	File = "file" + ":",
}
...
export let PreDefinedDataSourceIds = {
	...
	LinuxContainerApp:
		TargetResourceType.WebApp + ":" + TargetKind.LinuxContainerApp,
	LinuxFunctionApp:
		TargetResourceType.WebApp + ":" + TargetKind.FunctionAppLinux,
	LinuxContainerFunctionApp:
		TargetResourceType.WebApp + ":" + TargetKind.FunctionAppLinuxContainer,
