...
export class ServiceConnectionClient {
	...
	public async createGitHubServiceConnection(
		...
		>{
			...
			headers: {
				...
				"Accept":
					"application/json;api-version=5.1-preview.2;excludeUrls=true",
			},
			method: "POST",
			body: {
	...
	public async authorizeEndpointForAllPipelines(
		endpointId: string,
	): Promise<any> {
		...
		>{
			...
			headers: {
				"Content-Type": "application/json",
				"Accept":
					"application/json;api-version=5.1-preview.1;excludeUrls=true;enumsAsNumbers=true;msDateFormat=true;noArrayWrap=true",
			},
			method: "PATCH",
			body: {
				"allPipelines": {
