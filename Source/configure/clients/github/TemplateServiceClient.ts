...
export class TemplateServiceClient implements ITemplateServiceClient {
	...
	public async getTemplatesInfoByFilter(
		language: string,
		deployTarget: string,
		buildTarget: string,
	...
	public async getTemplateParameters(
		templateId: string,
	...
	public async getTemplateConfiguration(
		templateId: string,
	...
	public async getTemplateFile(
		...
		const requestUri =
			this.templateServiceUri + this.templateAssetFilesResource;
