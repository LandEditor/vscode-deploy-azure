import {
	GenericResource,
	ResourceListResult,
} from "azure-arm-resource/lib/resource/models";
...
export class AppServiceClient extends AzureResourceClient {
	...
	public async getAppServiceResource(
		resourceId: string,
	...
	public async GetAppServices(
		filtersForResourceKind: TargetKind[],
	...
	public async getWebAppPublishProfileXml(
		resourceId: string,
	): Promise<string> {
	...
	public async getAppServiceConfig(
		resourceId: string,
	...
	public async getAppServiceMetadata(
		resourceId: string,
	...
	public async updateAppServiceMetadata(
		resourceId: string,
	...
	public async publishDeploymentToAppService(
		resourceId: string,
		deploymentMessage: string,
		author: string = "VSTS",
		deployer: string = "VSTS",
	): Promise<Deployment> {
		let parsedResourceId: ParsedAzureResourceId = new ParsedAzureResourceId(
			resourceId,
		);
	...
	public async setSourceControl(
		resourceId: string,
		properties: any,
	): Promise<void> {
		await this.webSiteManagementClient.sendRequest<any>(<
			UrlBasedRequestPrepareOptions
		>{
	...
	public async getSourceControl(
		resourceId: string,
	): Promise<WebAppSourceControl> {
		return this.webSiteManagementClient.sendRequest<WebAppSourceControl>(<
			UrlBasedRequestPrepareOptions
		>{
			url: `${this.environment.resourceManagerEndpointUrl}${resourceId}/sourcecontrols/web`,
			method: "GET",
	...
	private createDeploymentObject(
		deploymentId: string,
		deploymentMessage: string,
		author: string,
		deployer: string,
