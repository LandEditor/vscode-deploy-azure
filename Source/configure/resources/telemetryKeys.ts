export class TelemetryKeys {
	...
	public static FF_UseGithubForCreatingNewRepository =
		"FF_UseGithubForCreatingNewRepository";
	public static FF_UseAzurePipelinesForGithub =
		"FF_UseAzurePipelinesForGithub";
