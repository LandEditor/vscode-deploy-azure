...
export const PipelineTemplateLabels = {
	...
	DotNetCoreFunctionAppToAzureFunction:
		".NET Core Function App to Azure Function",
	PythonFunctionAppToLinuxAzureFunction:
		"Python Function App to Linux Azure Function",
};
